({
    doInit: function(component, event, helper) {
        ...
        component.find("shopifyRecordCreator").getNewRecord(
            "Shopify_Configuration__c", // sObject type 
            null,      // recordTypeId
            false,     // skip cache?
    ...
    editModel: function(component, event, helper) {
        ...
        for(var i =0 ;i<shopdetails.length;i++){
            if(shopdetails[i].Id == value){
                ...
                component.set("v.EditAccessToken", shopdetails[i].Shopify_Access_Token__c);
                component.set("v.EditPassword", shopdetails[i].Password__c);
            }
        }
